...
void Cell_Renderer::Draw(int frame) {
    ...
    const vector<pair<int, pair<int, int>>>& sorted = m_solver.Get_Flat_DS();
...
/*
void Cell_Renderer::Draw(int frame , const Grid& grid , const vector<pair<int , pair<int , int>>>& sorted){
